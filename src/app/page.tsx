...
export default async function Home() {
  ...
  return (
    <div>
      ...
      <Image id="about-bakeful" src="/divider.svg" className="ml-auto mr-auto mt-5 mb-0" width="800" height="150" alt="Divider" />
      <Image src="/about-bakeful.png" className="-ml-4 mr-auto" width="800" height="400" alt="About Bakeful" />
      <Image id="products" src="/divider.svg" className="ml-auto mr-auto mt-0 mb-5" width="800" height="150" alt="Divider" />
